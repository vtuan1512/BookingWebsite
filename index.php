                ...
                <form>
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-2 mb-3">
                            ...
                            <select class="form-select shadow-none">
                                <option selected>Choose number of children</option>
                                <option value="1">One</option>
                                <option value="2">Two</option>
                                <option value="3">Three</option>
                            </select>
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px;margin:auto;">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="mb-4">1.200 per night</h6>
        ...
        <div class="swiper testimonials">
            <div class="swiper-wrapper mb-5">
                ...
                <div class="swiper-slide bg-white p-4">
                    ...
                    <p>
                        HSDFNLASJLKDLKASLDLJASJDLKASdasdadasd
                        dasdadasdadadsasfsafasdsad
                ...
                <div class="swiper-slide bg-white p-4">
                    ...
                    <p>
                        HSDFNLASJLKDLKASLDLJASJDLKASdadsadasdadad
                        dsadadasdsadasdsadadadgfdghdfhrtfhndfgsgsdg
                        fdsfsfdgd
