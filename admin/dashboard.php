            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-2 mb-4">
                        <a href="user_queries.php" class="text-decoration-none">
                            <div class="card text-center text-info p-1">
                                <h5>User Queries: <?php echo $unread_queries['count']; ?></h5>
                    ...
                    <div class="col-md-2 mb-4">
                        <a href="rating_review.php" class="text-decoration-none">
                            <div class="card text-center text-success p-1">
                                <h5>Rating & Review: <?php echo $reviews['count']; ?></h5>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-info p-1">
                            <h5>Total all Users: <?php echo $current_users['total'] ?></h5>
                        </div>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-success p-1">
                            <h5>Active Users: <?php echo $current_users['active'] ?></h5>
                        </div>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-warning p-1">
                            <h5>Inactive Users: <?php echo $current_users['inactive'] ?></h5>
                        </div>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-danger p-1">
                            <h5>Unverified Users :<?php echo $current_users['unverified'] ?></h5>
                        </div>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-info p-1">
                            <h5>Totol Hotels: <?php echo $hotel['total']; ?></h5>
                        </div>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-success p-1">
                            <h5>Active Hotels: <?php echo $hotel['active']; ?></h5>
                        </div>
                    </div>
                    <div class="col-md-2 mb-4">
                        <div class="card text-center text-warning p-1">
                            <h5>Inactive Hotels: <?php echo $hotel['inactive']; ?></h5>
                        </div>
                    </div>
                </div>
                <h3>TOP 3 HOTELS</h3>
                ...
                <div class="mb-4">
                    ...
                    $result = mysqli_query($con, "
                            SELECT hotel.rating, hotel.name, COUNT(*) AS count
                            FROM booking_order
                            JOIN hotel ON booking_order.hotel_id = hotel.id
                            GROUP BY booking_order.hotel_id
                            ORDER BY count DESC
                            LIMIT 3
                        ");
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<h6 class='text-danger'>Top $rank: {$row['name']}  {$row['rating']} <i class='bi bi-star-fill text-warning'></i></h6>";
                            $rank++;
                        }
                    } else {
                        echo "<h5>No top hotels found</h5>";
                    }
                    ?>
                </div>
