...
if (isset($_POST['info_form'])) 
{
    ...
    $u_exist = select(
        ...
        [$frm_data['phonenum'], $_SESSION['adminId']],"ss");
    ...
    $values=[$frm_data['name'],$frm_data['address'],$frm_data['phonenum'],
        $frm_data['pincode'],$frm_data['dob'],$_SESSION['adminId']];
...
if (isset($_POST['profile_form'])) 
{
    ...
    $u_exist = select("SELECT `profile` FROM `user_cred` WHERE `id`!=? LIMIT 1",[$_SESSION['adminId']],"s");
