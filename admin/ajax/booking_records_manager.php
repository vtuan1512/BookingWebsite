...
if (isset($_POST['get_bookings'])) {
    ...
    WHERE bo.hotel_id = ? AND (
        ...
        OR (bo.booking_status='payment_failed')) AND (bo.order_id LIKE ? OR bd.phone_num LIKE ? OR bd.user_name LIKE ?)
    ORDER BY bo.booking_id DESC";

$res = select($query, [$manager_hotel_id, "%$frm_data[search]%", "%$frm_data[search]%", "%$frm_data[search]%"], 'ssss');
