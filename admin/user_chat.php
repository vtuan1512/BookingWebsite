...
<body class="bg-light">
            ...
            <section class="users">
                <header>
                    <div class="content">
                        ...
                        $sql = mysqli_query($con, "SELECT * FROM `user_cred` WHERE `id`={$_SESSION['adminId']}");
                        $path = USERS_IMG_PATH;
    ...
    <script type="text/javascript" src="/admin/scripts/users_chat.js"></script> <!-- Adjust the path if necessary -->
