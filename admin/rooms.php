...
<body class="bg-light">
            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="table-responsive-lg" style="height: 800px; overflow-y:scroll;">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="desc" id="add_desc" rows="5" class="form-control shadow-none"></textarea>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label fw-bold">Description</label>
                                <textarea name="desc" id="edit_desc" rows="5" class="form-control shadow-none"></textarea>
                            </div>
    ...
    <script src="/admin/scripts/rooms.js"></script>
    <script src="/tinymce_7.1.2/tinymce/js/tinymce/tinymce.min.js"></script>
    <script>
        tinymce.init({
            selector: '#edit_desc , #add_desc',
            width: '100%',
            height: 300,
            plugins: [
        ...
        $('#room-s').on('shown.bs.modal', function() {
            tinymce.get('edit_desc , add_desc').remove(); // Remove existing instance if any
            tinymce.init({
                selector: '#edit_desc , #add_desc',
                plugins: [
