<div class="container-fluid bg-white mt-5">
    <div class="row">
        ...
        <div class="col-lg-4 p-4">
            ...
            <a href="recommend.php" class="d-inline-block mb-2 text-dark text-decoration-none">Blog</a><br>
...
<h6 class="text-center bg-dark text-white p-3 m-0">Booking DaLat </h6>
    ...
    register_form.addEventListener('submit', (e) => {
        ...
        xhr.onload = function() {
            if (this.responseText == 'password_mismatch') {
                ...
                alert('error', "Cannot send verification email ! Server down !");
            }
    ...
    login_form.addEventListener('submit', (e) => {
        ...
        xhr.onload = function() {
            if (this.responseText == 'inv_email_mob') {
                ...
                alert('error', "Email is not verified! Please check your email!");
            }
            else if (this.responseText == 'inactive'){
                alert('error', "Account not active! Please contact for Admin !");
            }
