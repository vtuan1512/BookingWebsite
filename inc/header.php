    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="recommend.php">Blog</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link me-2" href="special_voucher.php">Special Discount</a>
                </li>
                <li class="nav-item">
                    ...
                    echo <<<data
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg-end">
                                ...
                                <li><a class="dropdown-item" href="users.php">Chat</a></li>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="name" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6  mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="profile" type="file" accept="image/jpg, image/jpeg, image/png, image/webp" class="form-control shadow-none">
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="forgot-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: Alink will be sent to your email to reset your password.
                    </span>
                    <div class="mb-4">
                        <label class="form-label">Email </label>
