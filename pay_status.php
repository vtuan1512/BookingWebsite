    ...
    <div class="container">
        <div class="row">
            ...
            <?php 
                    ...
                    if($booking_fetch['trans_status']=="failed"){
                        echo<<<data
                        
                        <div class="col-12 px-4">
                            <p class="fw-bold alert alert-danger">
                                <i class="bi bi-exclamation-triangle-fill"></i>
                                Payment Failed ! <br> Please try again !<br> If you need more information please contact to admin!
                                <br><br>
                    ...
                    {                   
                        ...
                        <div class="col-12 px-4">
                            <p class="fw-bold alert alert-success">
                                ...
                                Payment Successful ! Booking successful.
                                <br><br>
                                <a href='bookings.php'>Go to Bookings</a>
                            </p>
                        </div>
